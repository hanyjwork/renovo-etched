...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            ${data.message ? `<div class="label">Message:</div><div class="message-box">${data.message}</div>` : '<div class="value" style="font-style:italic;">No additional message provided.</div>'}
        ...
        <div class="footer">Renovo Etched Technical Services LLC | Dubai, UAE</div>
    </div>
</body>
</html>`;
        ...
        const res = await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: 'Renovo Etched Website <info@renovo-etched.ae>',
                to: adminEmails,
