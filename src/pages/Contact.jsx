...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Send admin notification via backend function
    await base44.functions.invoke('sendInquiryNotification', { data: formData });

    // Send customer confirmation directly from frontend (allows external email addresses)
    ...
    const projectType = projectTypeLabels[formData.project_type] || formData.project_type;
    ...
    await base44.integrations.Core.SendEmail({
      ...
      body: `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>
        ...
        .header{background:#2D3436;padding:40px 20px;text-align:center}
        ...
        .details-box{background:#FAFAF8;border-left:4px solid #C4A77D;padding:20px;margin:30px 0}
        .detail-item{margin:8px 0;color:#666;font-size:15px}
        .detail-label{font-weight:600;color:#2D3436}
        .contact-info{background:#FAFAF8;padding:25px;border-radius:8px;margin:20px 0}
        .contact-link{color:#C4A77D;text-decoration:none;font-weight:600}
        .footer{background:#2D3436;color:#fff;padding:30px;text-align:center;font-size:14px}
        ...
        <div class="content">
          ...
          <div class="details-box">
            ...
            ${formData.message ? `<div class="detail-item"><span class="detail-label">Your Message:</span> ${formData.message}</div>` : ''}
          </div>
          ...
          <div class="contact-info">
            ...
            <div style="margin:10px 0">📞 Phone: <a href="tel:+971565440237" class="contact-link">+971 56 544 0237</a></div>
            <div style="margin:10px 0">✉️ Email: <a href="mailto:info@renovo-etched.ae" class="contact-link">info@renovo-etched.ae</a></div>
          </div>
        </div>
        <div class="footer">
